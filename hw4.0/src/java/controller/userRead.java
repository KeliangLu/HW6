 ...
 * @author kellu
 */
@WebServlet(name = "userRead", urlPatterns = {"/user/userread"})
public class userRead extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                //get the HTML table1 from the userReadQuery object.
                rq.douserRead();
                String table1 =rq.getHTMLTable1();
                //pass execution control to read.jsp along with the table1.
                request.setAttribute("table1",table1);
                String url="/user/userread.jsp";
